...
CardTour chokudai_search(const int& n_itr, int chokudai_width = 1, bool isDump = false){
...
void solve_chokudai(){
    dump("chokudai");
    // 順番を決めて
    CardTour best_state = chokudai_search(100, 1, 1);
    dump(best_state.seq);
